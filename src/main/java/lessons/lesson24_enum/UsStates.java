...
public enum UsStates {
    // Enum application icinde bir database gibi davranir
    ...
    public static String getStateNameFromAbbreviation(String abbreviation) {
        ...
        //* findFirst() methodu Optinal deger dondurur, pesine get() methodunu ekleyince String donmesini saglar
    }

    public static String getStateNameFromCapital(String capital) {
        return Arrays.
                stream(values()).filter(t -> t.getCapital().equals(capital)).
                findFirst().get().
                getStateName();
    }


    //? Example 1: Baskenti verilen state'in kisaltamasini ekrana yazdiran method...
