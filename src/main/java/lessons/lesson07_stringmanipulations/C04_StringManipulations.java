...
public class C04_StringManipulations {
    public static void main(String[] args) {
        ...
        //todo indexOf() method'u verilen character veya character'lerin "ilk görünümünün" index'ini verir.
        int idxA = str.indexOf("kara");
        System.out.println(idxA);//5

        //todo lastIndexOf() method'u verilen character veya character'lerin "son görünümün" index'ini verir.
        ...
        //todo indexOf() iki parametre ile kullanilirsa ikinci parametrede verilen sayi kadar character'i gectikten sonra
        ...
        //todo lastIndexOf() iki parametre ile kullanilirsa ikinci parametrede verilen sayiyi "index"
        //                   olarak kabul edip en bastan bu indexe kadar olan karakterleri bir kutu icine aliniz
        //                   ve lastIndexOf() method'unu sadece bu kutu icindeki String icin kullaniniz.
        ...
        //todo isEmpty() methodu bir String'in bos olup olmadigini kontrol eder
        ...
        //todo isBlank() hem "bos String" icin hem de "sadece space" iceren String'ler icin true return eder
        String x = "     ";
